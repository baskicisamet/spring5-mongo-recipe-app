package com.sam.spring5mongorecipeapp.bootstrap;
...
import com.sam.spring5mongorecipeapp.domain.Ingredient;
import com.sam.spring5mongorecipeapp.domain.Notes;
import com.sam.spring5mongorecipeapp.domain.Recipe;
import com.sam.spring5mongorecipeapp.domain.UnitOfMeasure;
import com.sam.spring5mongorecipeapp.repository.CategoryRepository;
...
import com.sam.spring5mongorecipeapp.repository.reactive.UnitOfMeasureReactiveRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	 private final CategoryRepository categoryRepository;
	    ...
	    public void onApplicationEvent(ContextRefreshedEvent event) {
	        ...
	        log.error("###########");
	    	log.error(reactiveRepository.count().block().toString()); //block means run it
	    }
